...
import com.se.enrollme.repository.TimeTableRepository;
...
public class TimeTableService {
    ...
    public  List<TimeTable> fetchDeptAll(String teacher_department) {

        return timeTableRepository.findByTeacher_department(teacher_department);
    }
